...
public class SharedTestData {
	...
	public static final TerrainType TERRAIN_TYPE_A = new TerrainTypeImpl(NAME_A, Color.RED, 1, 2.5);
	public static final TerrainType TERRAIN_TYPE_B = new TerrainTypeImpl(NAME_B, Color.GREEN, 0, 0);
	public static final TerrainType TERRAIN_TYPE_C = new TerrainTypeImpl(NAME_C, GROUP, Color.BLUE, -1, 0.5);
